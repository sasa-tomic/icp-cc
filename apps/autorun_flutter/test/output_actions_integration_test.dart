...
void main() {
  group('Output Actions Integration Tests', () {
    test('script runner includes helper functions', () {
      ...
      expect(helpers, contains('icp_searchable_list'));
    ...
    test('integration catalog includes helper descriptions and examples', () {
      ...
      // Check for searchable list helper
      final searchableListHelper = catalog.firstWhere((info) => info.id == 'icp_searchable_list');
      expect(searchableListHelper.title, equals('Searchable Result List'));
      expect(searchableListHelper.description, contains('searchable'));
      expect(searchableListHelper.example, contains('icp_searchable_list'));
    ...
    test('output helpers provide meaningful examples', () {
      final catalog = ScriptRunner.integrationCatalog;
