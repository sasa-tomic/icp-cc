...
impl ReviewRepository {
    ...
    pub async fn find_by_script(&self, script_id: &str, limit: i32, offset: i32) -> Result<Vec<Review>, sqlx::Error> {
    ...
    pub async fn count_by_script_and_user(&self, script_id: &str, user_id: &str) -> Result<i64, sqlx::Error> {
