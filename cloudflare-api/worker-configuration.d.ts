/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.local.jsonc` (hash: 75a6f10a3c82d878209ace920537ef19)
// Runtime types generated with workerd@1.20251011.0 2025-10-24 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./build/index");
	}
	interface Env {
		ENVIRONMENT: "local";
		DB: D1Database;
