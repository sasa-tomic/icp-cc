...
/// CLI entry point. Parses --count / --endpoint / --clean / --purge,
...
Future<void> main(List<String> args) async {
  ...
  print('==> seed_marketplace: endpoint=$endpoint '
      'mode=${opts.purge ? "purge" : "seed"} '
      'count=${opts.count} clean=${opts.clean}');
...
Future<bool> _uploadOne({
  ...
  final List<String> tags = <String>['bulk_seed', 'pagination', 'seed'];
  tags.sort();
...
void _printUsage() {
  ...
  print('                     this seeder\'s keypair, then exit.');
